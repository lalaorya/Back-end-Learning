...
public class Comsumer1 {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 参数5：队列其它参数
         */
        channel.queueDeclare(Comsumer1.DIRECT_QUEUE_PRINT, true, false, false, null);
         ...
         * 参数3：消息接收到后回调
         */
        channel.basicConsume(Comsumer1.DIRECT_QUEUE_PRINT, true, consumer);
    }
