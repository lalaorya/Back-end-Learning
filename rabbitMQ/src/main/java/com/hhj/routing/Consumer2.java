...
public class Consumer2 {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 参数5：队列其它参数
         */
        channel.queueDeclare(Consumer2.DIRECT_QUEUE_SAVE, true, false, false, null);
         ...
         * 参数3：消息接收到后回调
         */
        channel.basicConsume(Consumer2.DIRECT_QUEUE_SAVE, true, consumer);
    }
